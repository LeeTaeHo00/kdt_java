...
public class TwoArrayTest01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2차원 배열(행) : " + ar2.length);
		System.out.println("2차원 배열(열) : " + ar2[0].length);
		
		for(int i = 0; i < ar2.length; i++) // 행반복
		{
			System.out.println("ar2.length의 값(ar2의 행의 길이) : " + ar2.length);
			System.out.println("ar2의 각 행 : "  + i + "의 주소값: " + ar2[i]);
			for(int j = 0; j < ar2[i].length; j++) // 열반복 
			{
